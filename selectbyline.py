...
class selectbyline(QgsProcessingAlgorithm):
    ...
    def name(self):
        return 'selectbylinesselectbylocation'

    def displayName(self):
        return 'Select by lines (select by location)'
    ...
    def initAlgorithm(self, config=None):
        self.addParameter(QgsProcessingParameterVectorLayer(self.INPUT_LAYER_A,
                                                    'Line layer used for the selection',
        ...
        self.addParameter(QgsProcessingParameterDistance(self.BUFFER,
                                                         'Buffer distance for lines selection layer',
                                                         0.0001,
                                                         self.INPUT_LAYER_A,
                                                         False,
                                                         0,
