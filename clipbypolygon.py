...
class clipbypolygon(OgrAlgorithm):
    ...
    def defineCharacteristics(self):
        ...
        self.addParameter(ParameterString(self.FIELDS_A, 'Fields/attributes clip to be kept in results (comma separated list)',
                          '', optional=False))
        self.addParameter(ParameterVector(self.INPUT_LAYER_B, 'Layer to be clipped',
                          [ParameterVector.VECTOR_TYPE_POLYGON], False))
        self.addParameter(ParameterTableField(self.FIELD_B, 'Input layer ID',
                          self.INPUT_LAYER_B, optional=False))
        self.addParameter(ParameterString(self.FIELDS_B, 'Fields/attributes input layer to be kept in results (comma separated list)',
                          '', optional=False))
